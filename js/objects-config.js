...
ispy.detector_description = {
  ...
  "HcalForwardPlus3D_V1": {type: ispy.BOX, on: false, group: "Detector", name: "HCAL Forward (+)",
    fn: ispy.makeHcal, style: {color: "rgb(70%, 70%, 0%)", opacity: 0.5, linewidth: 0.5}},
  "HcalForwardRZ_V1": {type: ispy.BOX, on: false, group: "Detector", name: "HCAL Forward RZ",
    fn: ispy.makeHcal, style: {color: "rgb(70%, 70%, 0%)", opacity: 0.5, linewidth: 0.5}},
  ...
  "HcalOuter3D_V1": {type: ispy.BOX, on: false, group: "Detector", name: "HCAL Outer",
    fn: ispy.makeHcal, style: {color: "rgb(70%, 70%, 0%)", opacity: 0.5, linewidth: 0.5}},
  "HcalOuterRPhi_V1": {type: ispy.BOX, on: false, group: "Detector", name: "HCAL Outer RPhi",
    fn: ispy.makeHcal, style: {color: "rgb(70%, 70%, 0%)", opacity: 0.5, linewidth: 0.5}},
  "HcalOuterRZ_V1": {type: ispy.BOX, on: false, group: "Detector", name: "HCAL Outer RZ",
    fn: ispy.makeHcal, style: {color: "rgb(70%, 70%, 0%)", opacity: 0.5, linewidth: 0.5}},
  ...
  "HcalEndcapPlus3D_V1": {type: ispy.BOX, on: false, group: "Detector", name: "HCAL Endcap (+)",
    fn: ispy.makeHcal, style: {color: "rgb(70%, 70%, 0%)", opacity: 0.5, linewidth: 0.5}},
  "HcalEndcapRZ_V1": {type: ispy.BOX, on: false, group: "Detector", name: "HCAL Endcap RZ",
    fn: ispy.makeHcal, style: {color: "rgb(70%, 70%, 0%)", opacity: 0.5, linewidth: 0.5}},
  ...
  "HcalBarrel3D_V1": {type: ispy.BOX, on: false, group: "Detector", name: "HCAL Barrel",
    fn: ispy.makeHcal, style: {color: "rgb(70%, 70%, 0%)", opacity: 0.5, linewidth: 0.5}},
  "HcalBarrelRPhi_V1": {type: ispy.BOX, on: false, group: "Detector", name: "HCAL Barrel RPhi",
    fn: ispy.makeHcal, style: {color: "rgb(70%, 70%, 0%)", opacity: 0.5, linewidth: 0.5}},
  "HcalBarrelRZ_V1": {type: ispy.BOX, on: false, group: "Detector", name: "HCAL Barrel RZ",
    fn: ispy.makeHcal, style: {color: "rgb(70%, 70%, 0%)", opacity: 0.5, linewidth: 0.5}},
  ...
  "EcalEndcapPlus3D_V1": {type: ispy.BUFFERBOX, on: false, group: "Detector", name: "ECAL Endcap (+)",
    fn: ispy.makeEcal, style: {color: "rgb(50%, 80%, 100%)", opacity: 0.1, linewidth: 0.05}},
  "EcalEndcapRZ_V1": {type: ispy.BUFFERBOX, on: false, group: "Detector", name: "ECAL Endcap RZ",
  ...
  "EcalBarrel3D_V1": {type: ispy.BUFFERBOX, on: false, group: "Detector", name: "ECAL Barrel",
    fn: ispy.makeEcal, style: {color: "rgb(50%, 80%, 100%)", opacity: 0.1, linewidth: 0.05}},
  "EcalBarrelRPhi_V1": {type: ispy.BUFFERBOX, on: false, group: "Detector", name: "ECAL Barrel RPhi",
    fn: ispy.makeEcal, style: {color: "rgb(50%, 80%, 100%)", opacity: 0.75, linewidth: 0.1}},
  "EcalBarrelRZ_V1": {type: ispy.BUFFERBOX, on: false, group: "Detector", name: "ECAL Barrel RZ",
    fn: ispy.makeEcal, style: {color: "rgb(50%, 80%, 100%)", opacity: 0.75, linewidth: 0.1}},
  ...
  "TrackerRPhi_V1": {type: ispy.BOX, on: false, group: "Detector", name:"Tracker RPhi",
    fn: ispy.makeTrackerPiece, style: {color: "rgb(100%, 100%, 0%)", altColor: "rgb(70%, 70%, 0%)",
    opacity: 0.5, linewidth: 0.5}},
  "TrackerRZ_V1": {type: ispy.BOX, on: false, group: "Detector", name:"Tracker RZ",
    fn: ispy.makeTrackerPiece, style: {color: "rgb(100%, 100%, 0%)", altColor: "rgb(70%, 70%, 0%)",
    opacity: 0.5, linewidth: 0.5}},
...
ispy.event_description = {
  ...
  "EERecHits_V2": {type: ispy.SCALEDSOLIDTOWER, on: false, group: "ECAL", name: "Endcap Rec. Hits",
  ...
  "EBRecHits_V2": {type: ispy.SCALEDSOLIDTOWER, on: false, group: "ECAL", name: "Barrel Rec. Hits",
    fn: ispy.makeERecHit_V2, style: {color: "rgb(10%, 100%, 10%)", opacity: 0.5, linewidth: 0.5}, scale: 0.05, selection: {"min_energy": 0.5}},

  "HGCEERecHits_V1": {type: ispy.SCALEDSOLIDBOX, on: false, group: "ECAL", name: "HGC EE Rec. Hits",
  ...
  "HERecHits_V2": {type: ispy.SCALEDSOLIDBOX, on: false, group: "HCAL", name: "Endcap Rec. Hits",
    fn: ispy.makeHRecHit_V2, style: {color: "rgb(20%, 70%, 100%)", opacity: 0.5, linewidth: 0.25}, selection: {"min_energy": 1.0}},
  "HBRecHits_V2": {type: ispy.SCALEDSOLIDBOX, on: false, group: "HCAL", name: "Barrel Rec. Hits",
    fn: ispy.makeHRecHit_V2, style: {color: "rgb(20%, 70%, 100%)", opacity: 0.5, linewidth: 0.25}, selection: {"min_energy": 1.0}},

  "HGCHEBRecHits_V1": {type: ispy.SCALEDSOLIDBOX, on: false, group: "HCAL", name: "HGC HE Back Rec. Hits",
    fn: ispy.makeHGCRecHit, style: {color: "rgb(20%, 70%, 100%)", opacity: 0.5, linewidth: 0.25}, selection: {"min_energy": 0.01}},
  "HGCHEFRecHits_V1": {type: ispy.SCALEDSOLIDBOX, on: false, group: "HCAL", name: "HGC HE Front Rec. Hits",
    fn: ispy.makeHGCRecHit, style: {color: "rgb(20%, 70%, 100%)", opacity: 0.5, linewidth: 0.25}, selection: {"min_energy": 0.01}},

  "Tracks_V1": {type: ispy.ASSOC, on: false, group: "Tracking", name: "Tracks (reco.)",
  ...
  "Event_V1":{type: ispy.TEXT, on: false, group: "Provenance", name: "Event", fn: ispy.makeEvent, style: {}},
  "Event_V2":{type: ispy.TEXT, on: false, group: "Provenance", name: "Event", fn: ispy.makeEvent, style: {}},
  ...
  "DTRecSegment4D_V1": {type: ispy.LINE, on: false, group: "Muon", name: "DT Rec. Segments (4D)",
    fn: ispy.makeDTRecSegments, style: {color: "rgb(100%, 100%, 0%)", altColor: "rgb(100%, 50%, 0%)", opacity: 1.0, linewidth: 1.5}},

  "RPCRecHits_V1": {type: ispy.LINE, on: false, group: "Muon", name: "RPC Rec. Hits",
  ...
  "CSCRecHit2Ds_V2": {type: ispy.LINE, on: false, group: "Muon", name: "CSC Rec. Hits (2D)",
    fn: ispy.makeCSCRecHit2Ds_V2, style: {color: "rgb(60%, 100%, 90%)", opacity: 1.0, linewidth: 1}},
  "CSCSegments_V1": {type: ispy.LINE, on: false, group: "Muon", name: "CSC Segments",
    fn: ispy.makeCSCSegments, style: {color: "rgb(100%, 60%, 100%)", opacity: 1.0, linewidth: 1.5}},
  "CSCSegments_V2": {type: ispy.LINE, on: false, group: "Muon", name: "CSC Segments",
    fn: ispy.makeCSCSegments, style: {color: "rgb(100%, 60%, 100%)", opacity: 1.0, linewidth: 1.5}},
  "CSCSegments_V3": {type: ispy.LINE, on: false, group: "Muon", name: "CSC Segments",
    fn: ispy.makeCSCSegments, style: {color: "rgb(100%, 60%, 100%)", opacity: 1.0, linewidth: 1.5}},
  "MuonChambers_V1": {type: ispy.BOX, on: false, group: "Muon", name: "Matching muon chambers",
  ...
  "METs_V1": {type: ispy.SHAPE, on: false, group: "Physics", name: "Missing Et (Reco)",
    fn: ispy.makeMET, style: {color: "rgb(100%, 50%, 100%)", linewidth:2}, selection: {"min_pt": 0.0}},
  "PFMETs_V1": {type: ispy.SHAPE, on: false, group: "Physics", name: "Missing Et (PF)",
    fn: ispy.makeMET, style: {color: "rgb(100%, 50%, 100%)", linewidth:2}, selection: {"min_pt": 0.0}},
  "PATMETs_V1": {type: ispy.SHAPE, on: false, group: "Physics", name: "Missing Et (PAT)",
    fn: ispy.makeMET, style: {color: "rgb(100%, 50%, 100%)", linewidth:2}, selection: {"min_pt": 0.0}},

  "Jets_V1": {type: ispy.SHAPE, on: false, group: "Physics", name: "Jets (Reco)",
    fn: ispy.makeJet, style: {color: "rgb(100%, 100%, 0%)", opacity: 0.3}, selection: {"min_et": 0.0}},
  ...
  "GenJets_V1": {type: ispy.SHAPE, on: false, group: "Physics", name: "Jets (Sim)",
    fn: ispy.makeJet, style: {color: "rgb(100%, 75%, 0%)", opacity: 0.8}, selection: {"min_et": 0.0}},
  "PATJets_V1": {type: ispy.SHAPE, on: false, group: "Physics", name: "Jets (PAT)",
    fn: ispy.makeJet, style: {color: "rgb(100%, 100%, 0%)", opacity: 0.3}, selection: {"min_et": 0.0}},
  ...
  "PATPhotons_V1": {type: ispy.LINE, on: false, group: "Physics", name: "Photons (PAT)",
    fn: ispy.makePhoton, style: {color: "rgb(80%, 80%, 0%)", opacity: 1.0, linewidth: 1}},

  "GlobalMuons_V1": {type: ispy.ASSOC, on: false, group: "Physics", name: "Global Muons (Reco)",
  ...
  "GlobalMuons_V2": {type: ispy.ASSOC, on: false, group: "Physics", name: "Global Muons (Reco)",
    extra: "Points_V1", assoc: "MuonGlobalPoints_V1",
    fn: ispy.makeTrackPoints, style: {color: "rgb(100%, 0%, 0%)", opacity: 1.0, linewidth: 1.5}, selection:{"min_pt":1.0, "index":0}},
  "PATGlobalMuons_V1": {type: ispy.ASSOC, on: false, group: "Physics", name: "Global Muons (PAT)",
  ...
  "PATStandaloneMuons_V1": {type: ispy.ASSOC, on: false, group: "Physics", name: "Stand-alone Muons (PAT)",
    extra: "Extras_V1", assoc: "PATMuonTrackExtras_V1",
    fn: ispy.makeTracks, style: {color: "rgb(100%, 0%, 0%)", opacity: 1.0, linewidth: 1.5}, selection: {"min_pt":1.0, "index":0}},

  "TrackerMuons_V1": {type: ispy.ASSOC, on: false, group: "Physics", name: "Tracker Muons (Reco)",
    extra: "Points_V1", assoc: "MuonTrackerPoints_V1",
    fn: ispy.makeTrackPoints, style: {color: "rgb(100%, 0%, 0%)", opacity: 1.0, linewidth: 1.5}, selection:{"min_pt":1.0, "index":0}},
  "PATTrackerMuons_V1": {type: ispy.ASSOC, on: false, group: "Physics", name: "Tracker Muons (PAT)",
    extra: "Points_V1", assoc: "PATMuonTrackerPoints_V1",
    fn: ispy.makeTrackPoints, style: {color: "rgb(100%, 0%, 0%)", opacity: 1.0, linewidth: 1.5}, selection:{"min_pt":1.0, "index":0}},

  "GsfElectrons_V1": {type: ispy.ASSOC, on: false, group: "Physics", name: "Electron Tracks (GSF)",
    extra: "Extras_V1", assoc: "GsfElectronExtras_V1",
    fn: ispy.makeTracks, style: {color: "rgb(10%, 100%, 10%)", opacity: 0.9, linewidth: 1.5}, selection: {"min_pt":0.0, "index":0}},
  "GsfElectrons_V2": {type: ispy.ASSOC, on: false, group: "Physics", name: "Electron Tracks (GSF)",
    extra: "Extras_V1", assoc: "GsfElectronExtras_V1",
    fn: ispy.makeTracks, style: {color: "rgb(10%, 100%, 10%)", opacity: 0.9, linewidth: 1.5}, selection: {"min_pt":0.0, "index":0}},
  "GsfElectrons_V3": {type: ispy.ASSOC, on: false, group: "Physics", name: "Electron Tracks (GSF)",
    extra: "Extras_V1", assoc: "GsfElectronExtras_V1",
    fn: ispy.makeTracks, style: {color: "rgb(10%, 100%, 10%)", opacity: 0.9, linewidth: 1.5}, selection: {"min_pt":0.0, "index":0}},
  "PATElectrons_V1": {type: ispy.ASSOC, on: false, group: "Physics", name: "Electron Tracks (PAT)",
